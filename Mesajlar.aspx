                ...
                <table class="auto-style5">
                    <tr>
                        ...
                        <td class="auto-style7">
                           <a href ="MesajDetay.aspx?Mesajid=<%#Eval("Mesajid")%>"><asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/iconlar/read2.png" Width="30px" CssClass="auto-style20" /></a> 
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
